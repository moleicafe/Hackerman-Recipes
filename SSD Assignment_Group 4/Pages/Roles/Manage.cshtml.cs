...
namespace SSD_Assignment_Group_4.Pages.Roles
{
    ...
    public class ManageModel : PageModel
    {
        ...
        public ManageModel(SSD_Assignment_Group_4.Data.SSD_Assignment_Group_4Context context, UserManager<RecipeUser> userManager, RoleManager<ApplicationRole> roleManager)
        {
            _context = context;
        ...
        public async Task<IActionResult> OnPostAsync(string selectedusername, string selectedrolename)
        {
            ...
            RecipeUser AppUser = _context.Users.SingleOrDefault(u => u.UserName == selectedusername);
        ...
        public async Task<IActionResult> OnPostDeleteUserRoleAsync(string delusername, string delrolename)
        {
            ...
            RecipeUser user = _context.Users.Where(u => u.UserName == delusername).FirstOrDefault();
